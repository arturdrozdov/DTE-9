...
export default function NotificationPage() {
    ...
    return (
        <div className={"w-full max-h-100dvh flex justify-center min-h-screen flex-col items-center select-none " + inter.className}>
                ...
                <div className="flex flex-col w-full py-6 relative bottom-20">
                    <div className="flex items-center w-full justify-between pr-[25px] mb-3 ">
                        ...
                        <div className="flex flex-col justify-center flex-1">
                            ...
                            <span className="text-white text-[14px] font-light tracking-[-1%] leading-[19px]">Your DTE is due! Completing it now will keep you on track to meet your weekly goal of four.
