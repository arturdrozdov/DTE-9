            ...
            {currentSlide === 2 && (
              <div className="flex-1 flex flex-col">
                ...
                <div className="flex-1 flex flex-col gap-3 text-left">
                  ...
                  >
                    <span className="w-[28px] h-[28px] inline-flex items-center justify-center bg-[#353535] rounded-full mr-2.5 font-bold text-[14px] text-[#FFFFFF80]">5</span><span className="text-[16px] text-white">I’ve been steady and composed, even under pressure.</span>
                  </button>
                  ...
                  <button
                    ...
                    className="w-full text-left flex items-center px-[15px] h-[60px] bg-[#FFFFFF0A] active:bg-[#FFFFFF26] border border-[#FFFFFF33] rounded-[30px] text-white transition-all"
                  >
                    <span className="w-[28px] h-[28px] inline-flex items-center justify-center bg-[#353535] rounded-full mr-2.5 font-bold text-[14px] text-[#FFFFFF80]">4</span><span className="text-[16px] text-white">I can settle myself pretty well when things get tough.</span>
                  </button>
                  ...
                  <button
                    ...
                    className="w-full text-left flex items-center px-[15px] h-[60px] bg-[#FFFFFF0A] active:bg-[#FFFFFF26] border border-[#FFFFFF33] rounded-[30px] text-white transition-all"
                  >
                    <span className="w-[28px] h-[28px] inline-flex items-center justify-center bg-[#353535] rounded-full mr-2.5 font-bold text-[14px] text-[#FFFFFF80]">3</span><span className="text-[16px] text-white">I hold it together sometimes, but not always.</span>
                  </button>
                  ...
                  >
                    <span className="w-[28px] h-[28px] inline-flex items-center justify-center bg-[#353535] rounded-full mr-2.5 font-bold text-[14px] text-[#FFFFFF80]">2</span><span className="text-[16px] text-white">I lose control quickly when things go wrong.</span>
                  </button>
                  ...
                  <button
                    ...
                    className="w-full text-left flex items-center px-[15px] h-[60px] bg-[#FFFFFF0A] active:bg-[#FFFFFF26] border border-[#FFFFFF33] rounded-[30px] text-white transition-all"
                  >
                    <span className="w-[28px] h-[28px] inline-flex items-center justify-center bg-[#353535] rounded-full mr-2.5 font-bold text-[14px] text-[#FFFFFF80]">1</span><span className="text-[16px] text-white">I feel reactive and scattered most of the time.</span>
                  </button>
                </div>
              </div>
            )}
